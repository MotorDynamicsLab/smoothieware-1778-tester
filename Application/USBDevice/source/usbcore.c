...
#else
static inline uint32_t USB_GetStatus (void) {
#endif
  uint32_t n, m;
...
#else
static inline uint32_t USB_SetClrFeature (uint32_t sc) {
#endif
  uint32_t n, m;
...
#else
static inline uint32_t USB_GetDescriptor (void) {
#endif
  uint8_t  *pD;
  uint32_t len, n;
...
#else
static inline uint32_t USB_SetConfiguration (void) {
#endif
...
#else
static inline uint32_t USB_SetInterface (void) {
#endif
  USB_COMMON_DESCRIPTOR *pD;
